			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3">
						<h2>Reset Password</h2>
                        <p>Enter your new password, then select Change Password.</p>
                        @if (session('status'))
						...
						{{ csrf_field() }}
                            ...
                            <div class="row form-group{{ $errors->has('email') ? ' has-error' : '' }}">
								<div class="col-md-12">
									...
									<input type="email" id="email" name="email" class="form-control" placeholder="E-Mail Address" value="{{ $email or old('email') }}">
									@if ($errors->has('email'))
