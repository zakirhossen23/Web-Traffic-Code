					...
					<div class="col-md-6 col-md-offset-3">
						...
						{{ csrf_field() }}
							...
							<div class="row form-group{{ $errors->has('username') ? ' has-error' : '' }}">
								<div class="col-md-12">
									<!-- <label for="email">Email</label> -->
									<input type="text" id="username" class="form-control" name="username" placeholder="Username" value="{{ old('username') }}">
							...
							<div class="form-group">
								...
								<div class="text-right">
									Already have an account? <a href="{{ url('/login') }}" class="text-info">Login</a>
								</div>
							</div>
						</form>		
					</div>
