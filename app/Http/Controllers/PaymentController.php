...
class PaymentController extends Controller
{
    ...
    {
        return view('PostPayment');
    }

    public function PostPayment(Request $request)
    {
        Session::set('payment_amount', $request->get('amount'));
        $payer = new Payer();
        ...
        $transaction->setAmount($amount)
            ...
            ->setDescription($request->get('item_number') . ' - Surfing Credits');
    ...
    public function getPaymentStatus()
    {
        ...
        if ($result->getState() == 'approved') {
            ...
            $pack = Credit::where('price', $payment_amount)->first();
            User::whereId(Auth::user()->id)->increment('credits', $pack->credits);
